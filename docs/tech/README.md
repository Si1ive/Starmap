...
- [用户端真实模拟考与练习实现](./user-practice-implementation.md) - 真题组卷、冻结快照、服务器限时作答、交卷批改、复盘与覆盖统计
- [真实学习进度与艾宾浩斯投影](./learning-progress-ebbinghaus.md) - 题目/知识点关键词归并、记忆强度更新、复习阈值与用户端曲线
