...
| 会话详情聚合 | `backend/app/modules/agent/admin_router.py` | `get_run_detail` | L486-L579 | 一次读取 Thread 下 messages、runs、events、approvals、artifacts 与 Agent 来源练习，并构造成 `turns[]`、`practices[]` |
