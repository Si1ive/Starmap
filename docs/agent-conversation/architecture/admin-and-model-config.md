...
| 会话详情聚合 | `backend/app/modules/agent/admin_router.py` | `get_run_detail` | L486-L604 | 一次读取 Thread 下 messages、runs、events、approvals、artifacts、Agent 来源练习与学习活动，并构造成 `turns[]`、`practices[]`、`learning_activities[]` |
