        ...
        return (
            {
                ...
                "mastery_alpha": source.mastery_alpha,
                "mastery_beta": source.mastery_beta,
                "evidence_mass": source.evidence_mass,
                "uncertainty": source.uncertainty,
                "last_evidence_id": source.last_evidence_id,
                "last_graded_at": utc_isoformat(source.last_graded_at),
                "last_evidence_at": utc_isoformat(source.last_evidence_at),
                "state_model_version": source.state_model_version,
            },
