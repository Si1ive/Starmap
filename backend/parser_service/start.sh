...
echo "[parser-service] starting on ${HOST}:${PORT} with default parser=${DEFAULT_PARSER}, model_source=${MINERU_MODEL_SOURCE}, config_json=${MINERU_TOOLS_CONFIG_JSON}, render_threads=${MINERU_PDF_RENDER_THREADS}, render_timeout=${MINERU_PDF_RENDER_TIMEOUT}, window_size=${MINERU_PROCESSING_WINDOW_SIZE}"
