...
Revision ID: 20260714_content_review_decoupled
...
revision: str = "20260714_content_review_decoupled"
...
def upgrade() -> None:
    op.add_column(
        "knowledge_points",
        sa.Column("reviewed_by", sa.String(length=32), nullable=True, comment="审核人"),
    )
    op.add_column(
        "knowledge_points",
